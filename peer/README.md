...
(http://godoc.org/github.com/sectoken-dev/godash/peer)
...
```bash
$ go get -u github.com/sectoken-dev/godash/peer
```

## Examples

* [New Outbound Peer Example]
  (https://godoc.org/github.com/sectoken-dev/godash/peer#example-package--NewOutboundPeer)  
